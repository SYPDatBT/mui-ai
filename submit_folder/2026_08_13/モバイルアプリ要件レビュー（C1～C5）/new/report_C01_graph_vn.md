...
- Ở graph giá trị ngày・tháng, so sánh được với trung bình hộ tương tự (trục thời gian chỉ có giá trị tháng. Chủng loại graph dự kiến là lượng tiêu thụ gas・lượng tiêu thụ điện・lượng phát điện nhưng theo requirement vẫn cần xác nhận)
  - "Trung bình hộ tương tự" là khái niệm khác với trung bình thực tế của chính nhà mình ở trên. Định nghĩa "hộ tương tự" vẫn chưa chốt, requirement để song song 2 phương án (a. nhóm riêng cho EMINEL tạo từ giá trị nhập lúc onboarding／b. kế thừa thông tin thuộc tính TagTag đang có); tính toán theo cập nhật nhóm 1 lần/tháng. Ở hiện hành, so sánh trung bình chỉ có ở đơn vị năm (gas・điện・dầu hỏa・phát điện); điểm mở rộng của yêu cầu mới là thêm so sánh trung bình cho cả giá trị ngày・tháng
...
- Lượng điện năng tiêu thụ (消費電力量, kWh): giá trị tính theo công thức "điện mặt trời + phát điện gas + xả pin lưu trữ − sạc pin lưu trữ + mua điện − bán điện"
  - Ở hiện hành mục này được hiển thị dưới tên 「電気消費量」
