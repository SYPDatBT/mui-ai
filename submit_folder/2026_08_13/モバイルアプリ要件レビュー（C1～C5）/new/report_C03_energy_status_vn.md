...
| Mục | Nội dung |
|---|---|
| Trạng thái | Đang review (theo header md) ※trên slide đối khách đã là レビュー済 (README phản ánh 2026-08-05) |
...
- Xem được hiện có đang phát điện hay không (trạng thái phát điện) và công suất phát điện hiện tại (W)
  - Hiện hành đối tượng là trạng thái phát điện của Coremo／Enefarm, chạm vào icon trạng thái phát điện thì hiện số liệu công suất phát điện. Yêu cầu mới chỉ kế thừa phần What (xem được trạng thái phát điện + công suất W); cách hiển thị kiểu chạm icon không được đưa vào requirement
