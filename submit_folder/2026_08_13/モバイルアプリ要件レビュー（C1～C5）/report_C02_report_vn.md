...
- Xem được so sánh với hộ tương tự (xếp hạng quy đổi 100 hộ, gas・điện・tổng hợp)
  - Có cogen thì chỉ hiển thị tổng hợp. Nếu số lượng nhóm dưới mức tối thiểu thì hiển thị theo nhóm lớn hơn (trước khi lọc)
...
- Hiển thị phí báo cáo tháng (gộp 1 khoản duy nhất, vì phí EMINEL chỉ có 1 phí cơ bản nên không tách được gas/điện) → Xác nhận với Hokkaido Gas
