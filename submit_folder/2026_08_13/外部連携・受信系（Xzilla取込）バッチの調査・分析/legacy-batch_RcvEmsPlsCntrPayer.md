...
| Điều kiện lọc file | Chỉ nhận file có đuôi `.csv` ([:85](e:/Projects/mui/legacy_eminel_docs-main/sources/conciergesv-develop/src/Command/RcvEmsPlsCntrPayerCommand.php#L85)) |
...
- Lỗi ở bước tải/ghi log → `rollback` toàn bộ transaction ([:152-153](e:/Projects/mui/legacy_eminel_docs-main/sources/conciergesv-develop/src/Command/RcvEmsPlsCntrPayerCommand.php#L152-L153), [:161-164](e:/Projects/mui/legacy_eminel_docs-main/sources/conciergesv-develop/src/Command/RcvEmsPlsCntrPayerCommand.php#L161-L164)).
