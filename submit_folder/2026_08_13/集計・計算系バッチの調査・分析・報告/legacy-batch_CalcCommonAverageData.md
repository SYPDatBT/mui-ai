...
Nguồn: `CalcCommonAverageDataCommand.php:112-407` (3 hàm `retroactiveDaily/Monthly/Yearly`), `418-815` (`updateRetroactiveData`, `getRetroactiveUpdatePeriod`, `getRetroactiveData`, `getAggregationTarget`, `getTargetGroup`).
