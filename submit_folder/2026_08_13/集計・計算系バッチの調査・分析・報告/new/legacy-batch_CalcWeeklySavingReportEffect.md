...
② Tra diện tích sàn chuẩn (building_area) theo mã floor_area (1~6):
   ...
   (mã khác → building_area = null → bước ④ sẽ không tính được (null))
...
④ Nếu (①) đủ dữ liệu VÀ building_area VÀ unitCharge đều có giá trị:
     ...
     → cắt bỏ từ chữ số thập phân thứ 3 trở đi (giữ 2 chữ số thập phân, floor × 100 / 100)
