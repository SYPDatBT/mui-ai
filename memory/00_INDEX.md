...
1c. **MỞ LẠI QAデータベース KIỂM TRẠNG THÁI — đã làm 3/4, CÒN 1.** ✅ **No. 1** 担当範囲…とアプリ対象外 (chốt 08-13 **12:27**) ・ ✅ **No. 2** 独立デプロイ (**12:28**) ・ ✅ **No. 3** 管理画面は独立か共通か (**12:28**) — cả ba đã vào guide. ⬜ Còn **1 phiếu** duy nhất của bảng §9.4 vẫn ghi 「回答中」 (số phiếu chưa biết): 「**旧EMINEL調査範囲（conciergesv/eminelsv）とhemssv対象外の確認**」 (回答者 swan). **Rất có thể cũng đã 完了** — 4 phiếu đã kiểm (No. 1 ・ 2 ・ 3 ・ 10) đều đóng trong **cùng 2 phút** ngày 08-13 ⇒ mui dọn QA theo đợt. Cộng các trang 回答中 ở việc số 8. Nhớ: `完了` cũng là "đã trả lời" — **grep `回答済` sẽ sót**.
