...
| `requirements/` | The study documentation set. `README.md` is the design/review framework for the documents; `onboarding_guide.md` is the main learning guide (v1.1, 10 chapters + 7 appendices, ~4,000 lines) with images in `assets/`; `qa_kitagas.md` is the bilingual (Vietnamese–Japanese) question list for the customer. |
